...
* A Ubuntu based server with at least 4GB of RAM and 20GB of free disk space
...
1. Configure RAAD by the following steps.
    ...
    - To sync facility information to Cloud run the following command `sudo bash /opt/openmrs/configure_facility.sh`
2. Rebuild search index ** Note wait for initialization to finish
    - To do that first go to `https://<machine-ip/localhost>/openmrs/` And login with the credentions on `Access the application` section. Then navigate to `admin`

    ![alt-text](images/image25.png)

    - Scroll down and navigate to `Search Index` 

    ![alt-text](images/image26.png)

    - Click `Rebuild Search Index` Button and wait for it to finish.

    ![alt-text](images/image27.png)

    - After its finish you should see the following page

    ![alt-text](images/image28.png)
3. Create user accounts for your users.
4. Train your users on how to use RAAD.
